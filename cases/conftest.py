...
def staking_client(noconsensus_client_unanalyze):
    amount = noconsensus_client_unanalyze.economic.create_staking_limit * 2
    address, _ = noconsensus_client_unanalyze.account.generate_account(noconsensus_client_unanalyze.node.web3, amount)
    tx_hash = noconsensus_client_unanalyze.builtin_rpc.create_staking(0, address, address, reward_per=1000)
